    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <Text style={[styles.cardSectionLabel, { marginTop: 14 }]}>ARTISAN INSPECTION PHOTO</Text>
          <View style={styles.photoBox}>
            ...
            <View style={styles.verifiedPhotoBadge}>
              ...
              <Text style={styles.verifiedPhotoText}>Captured on-site during inspection</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.priceRow}>
            <Text style={styles.priceLabel}>Base Service & Diagnosis</Text>
          ...
          <View style={styles.totalRow}>
            <Text style={styles.totalLabel}>New Revised Total</Text>
        ...
        <View style={styles.ruleBanner}>
          ...
          <Text style={styles.ruleText}>
            <Text style={{ fontWeight: '800' }}>Cooperative Transparency Rule:</Text> Artisans are prohibited from requesting offline cash. All additional scope must be authorized through the UniServ app.
          </Text>
        </View>
      </ScrollView>
