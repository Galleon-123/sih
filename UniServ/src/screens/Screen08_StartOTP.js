      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.otpCard}>
          ...
          <Text style={styles.otpExpiresText}>
            <Ionicons name="time-outline" size={12} color={colors.textSecondary} /> Valid for this active session
          </Text>
        </View>
        ...
        <View style={styles.workerSummaryCard}>
          ...
          <View style={styles.workerRow}>
            ...
            <View style={styles.workerInfoCol}>
              ...
              <Text style={styles.workerSkill}>{worker?.skill || 'Plumber'} • {worker?.cooperative || 'Delhi Labour Cooperative'}</Text>
              <View style={styles.badgeRow}>
                <Ionicons name="shield-checkmark" size={12} color={colors.successDark} />
                <Text style={styles.badgeText}>Photo & KYC Verified Match</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.fareSummaryCard}>
          <View style={styles.fareHeaderRow}>
            <View style={{ flex: 1 }}>
              <Text style={styles.fareServiceTitle}>
                {activeBooking?.service?.name || 'Cooperative Service'}
              </Text>
              <Text style={styles.fareSubtypeText} numberOfLines={1}>
                {activeBooking?.trade_subtype || 'Standard Diagnosis & Service'}
              </Text>
            </View>
            <View style={styles.farePriceBadge}>
              <Text style={styles.farePriceLabel}>CURRENT FARE</Text>
          ...
          <View style={styles.fareWageNoteRow}>
            ...
            <Text style={styles.fareWageNoteText}>
              80% (₹{((activeBooking?.total_amount || activeBooking?.base_amount || 299) * 0.8).toFixed(0)}) directly compensates {worker?.name || 'the artisan'}.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.safetyBox}>
          ...
          <View style={styles.safetyTextCol}>
            <Text style={styles.safetyTitle}>Never share OTP before physical arrival!</Text>
            <Text style={styles.safetyDesc}>
              If a different person arrived, do not share this OTP and report an identity mismatch below.
            </Text>
          </View>
        </View>
